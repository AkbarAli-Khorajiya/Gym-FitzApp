        ...
        <SafeAreaView style={styles.screen} >
            <ScrollView style={styles.container}>
                <View style={styles.breadcrumb}>
                    ...
                    <Text style={styles.breadcrumbText}>Step 5 of 8</Text>
                ...
                <View style={styles.body} >
                    <View style={styles.title}>
                        <Text style={styles.titleText}>Select weight</Text>
                    </View>
            ...
            <TouchableOpacity
                style={styles.btn}
                onPress={() => (navigation.navigate('SelectGoalWeight'))}
                underlayColor="#ccc"
            >
