        ...
        <SafeAreaView style={styles.screen} >
            <ScrollView style={styles.container}>
                <View style={styles.breadcrumb}>
                    ...
                    <Text style={styles.breadcrumbText}>Step 4 of 8</Text>
                ...
                <View style={styles.body} >
                    <View style={styles.title}>
                        <Text style={styles.titleText}>Select height</Text>
                    </View>
                    ...
                    </View>
                    {
                        selectSegment == 0 ? <View style={styles.inpGroup}>
                            ...
                            <Text style={styles.inpGroupText}>feet</Text>
                        </View>
                            : <View style={styles.inpGroup}>
                                <TextInput style={styles.input} />
                                <Text style={styles.inpGroupText}>cm</Text>
                            </View>
                    }
